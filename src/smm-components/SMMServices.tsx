                            ...
                            {standardFeaturesSMM.map((feature, i) => (
                                <li className='flex items-center gap-3' key={i}>
                                    <svg className='shrink-0' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3.33325 10.5093L7.43582 14.5833L16.6666 5.41667" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                    <div>{feature}</div>
                                </li>
                            ))}
