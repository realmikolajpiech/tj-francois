    ...
    return (
        <section className="w-full md:mt-6">
            <div className="md:flex">
                <div className="px-6 md:px-8 lg:px-12 xl:px-20 md:pr-1 w-full text-center">
                    {/* <a href="/">
                    ...
                    <h2 className="mt-[28px] max-w-[700px] mx-auto text-[16px] md:text-[18px] lg:text-[20px] leading-tight">Meet the founders, the internal team, and our dedicated, passionate team of social media managers and creators.</h2>
                </div>
            </div>
        </section>
    )
