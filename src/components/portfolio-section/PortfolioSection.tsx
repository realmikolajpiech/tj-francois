            ...
            <div className="flex overflow-hidden gap-10 relative w-full h-[850px] items-center mt-48 mb-16 md:-mt-36 md:-mb-8 lg:-mt-48 xl:-mt-[0] lg:pt-[0] animate-stop pointer-events-none">
                <div className='flex scale-[70%] md:scale-100 animate-scroll absolute mt-10 sm:mt-16 xl:mt-24 group' ref={carouselRef}>
                    <div className="flex gap-[4.5rem] shrink-0 -translate-x-[11rem]">
                        <Phone imgOrVid="video" video="/creators/betty2.mp4" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="image" img="/images/damian.jpg" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="video" video="/creators/roby.mp4" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="video" video="/creators/ericka.mp4" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="video" video="/portfolio/pet2.mp4" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="image" img="/images/angie.jpg" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="video" video="/creators/rob.mp4" stopCarousel={stopCarousel} />
                        <Phone imgOrVid="video" video="/portfolio/beauty2.mp4" stopCarousel={stopCarousel} />
                    </div>
