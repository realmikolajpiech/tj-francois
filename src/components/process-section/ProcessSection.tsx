    ...
    return (
        <section className="px-6 md:px-8 lg:px-12 xl:px-20 mt-20 max-w-[96rem] lg:mx-auto">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-center lg:flex-col lg:justify-end lg:w-fit lg:ml-auto lg:gap-10">
                    <div className="relative">
                        ...
                        />
                        <div className="process-phones absolute top-[69%] xl:-left-1/2 xl:-translate-x-[60%] ps:-left-[30rem] -left-72 flex">
                            <div className="phone-process-1 w-[200px] overflow-hidden grow-0 shrink-0 justify-center hidden lg:flex ps:mx-0 -mx-24">
                                <div>
                            ...
                            <div className="hidden ps:flex phone-process-2 -mx-20 w-[200px] overflow-hidden grow-0 shrink-0 justify-center">
                                <div>
                                    <div className="relative h-[420px] w-[216px] scale-[70%]">
                                        <Image src="/portfolio/phone-mockup.png" width={250} height={250} alt="Phone"
                                            className="w-[200px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none h-[120%]"
                                ...
                                <div>
                                    <div className="relative h-[420px] w-[216px] scale-[70%]">
                                        ...
                                        <video muted loop autoPlay width={800} playsInline
                                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 rounded-[25px] w-[191px] h-[385px] object-cover"
                                        >
                                            <source src="/creators/debby.mp4" width={800} type="video/mp4" className="z-0" />
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                </div>
                ...
                <div className="relative lg:-top-24 lg:mr-96 xl:mr-56 step3">
                    <ProcessStep
                        number="3"
                        title="Creation"
                    ...
                    />
                    <div className="process-phones2 absolute top-[50%] lg:-right-1/2 lg:-translate-x-[60%] ps:-right-[42rem] flex">
                        <div className="phone-process-1 w-[200px] overflow-hidden grow-0 shrink-0 justify-center hidden lg:flex ps:mx-0 -mx-24">
                            <div>
                                <div className="relative h-[420px] w-[216px] scale-[70%]">
                                    <Image src="/portfolio/phone-mockup.png" width={250} height={250} alt="Phone"
                            ...
                            <div>
                                <div className="relative h-[420px] w-[216px] scale-[70%]">
                                    ...
                                    <video muted loop autoPlay playsInline
                                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 rounded-[25px] w-[191px] h-[385px] object-cover"
                                    >
                                        <source src="/shots/yosmi.mp4" type="video/mp4" className="z-0" />
                                        Your browser does not support the video tag.
                                    </video>
                                </div>
                            </div>
