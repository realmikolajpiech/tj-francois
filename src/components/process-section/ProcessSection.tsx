    ...
    return (
        <section className="px-6 md:px-8 lg:px-12 xl:px-20 mt-20 max-w-[96rem] lg:mx-auto">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="lg:-mt-0 flex justify-center lg:flex-col lg:justify-end lg:w-fit lg:ml-auto lg:gap-10 max-lg:w-full">
                ...
                <div className="relative lg:-mt-0 lg:-top-24 lg:mr-96 xl:mr-56 step3">
                    <ProcessStep
                        number="3"
                        title="Creation"
