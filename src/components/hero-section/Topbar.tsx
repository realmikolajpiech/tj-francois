    ...
    return (
        <nav className="flex flex-col">
            <div className="py-3 lg:py-8 px-6 md:px-8 lg:px-12 xl:px-20 bg-[#EDDCC4] md:bg-transparent md:p-6 relative">
                ...
                <div className="hidden md:flex md:gap-[2.5vw] lg:gap-8 w-fit justify-center absolute top-6 right-6 lg:top-8 lg:right-12 xl:right-20">
                    ...
                    <a href="https://www.instagram.com/vitalsocials.co">
                    ...
                    <a href="https://www.linkedin.com/in/tj-francois">
                        <svg width="28" height="27" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.threads.net/@vitalsocials.co">
            ...
            <svg className="md:hidden w-full -mt-[11vw] relative -z-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#EDDCC4" fill-opacity="1" d="M0,192L60,181.3C120,171,240,149,360,160C480,171,600,213,720,213.3C840,213,960,171,1080,165.3C1200,160,1320,192,1380,208L1440,224L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
        </nav>
    )
}